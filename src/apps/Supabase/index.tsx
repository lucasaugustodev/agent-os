...
export default function SupabaseApp(_props: AppComponentProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full gap-3"
      ...
      <h2 className="text-base font-semibold" style={{ color: '#e0e0e0' }}>Supabase</h2>
      <p className="text-sm text-center max-w-xs">Gerenciamento do banco de dados Supabase.</p>
